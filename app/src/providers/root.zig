...
pub const ChatRequest = struct {
    ...
    /// gemini-cli / claude-cli / codex-cli: directory for storing session state files.
    ...
    /// gemini-cli / claude-cli / codex-cli: working directory for the subprocess (the actual project).
